...
class PackageMapperTest {
        ...
        void toDTO_fullPackage() {
            var belongsToCategory =
                    new CIMSBelongsToCategory(
                            ...
                            new RDFSLabel("TestParentPackage", "en"),
                            UUID.randomUUID());
            ...
            assertAll(
                    ...
                    () ->
                            assertThat(dto.getBelongsToCategory().getPrefix())
                                    .isEqualTo("http://example.org/Packages#"),
                    () ->
                            assertThat(dto.getBelongsToCategory().getLabel())
                                    .isEqualTo("TestParentPackage"),
                    () ->
                            assertThat(dto.getBelongsToCategory().getUuid())
                                    .isEqualTo(belongsToCategory.getUuid()));
        }
    ...
    class toCIMPackageTests {
        ...
        void toCIMObject_fullPackage() {
            ...
            packageDTO.setBelongsToCategory(
                    new BelongsToCategoryDTO(
                            "http://example.org/Packages#",
                            "TestParentPackage",
                            UUID.randomUUID()));
            ...
            assertAll(
                    ...
                    () ->
                            assertThat(mappedCIMPackage.getLabel())
                                    .isEqualTo(new RDFSLabel("TestPackage", "en")),
                    () ->
                            assertThat(mappedCIMPackage.getComment())
                                    .isEqualTo(
                                            new RDFSComment(
                                                    "Test comment",
                                                    new URI(
