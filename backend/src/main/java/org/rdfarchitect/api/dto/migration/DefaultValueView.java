...
@Data
@AllArgsConstructor
public class DefaultValueView {
    private String classLabel;
    private List<SemanticAttributeChange> attributes;
    private List<SemanticAssociationChange> associations;
    private List<SemanticEnumEntryChange> enumEntries;
}
