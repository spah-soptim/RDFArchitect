...
public class CIMObjectFactory {
     ...
     */
    private static <T> List<T> createObjectList(
            ResultSet resultSet, Function<QuerySolution, T> creator) {
     ...
     *
     * @param classQuerySolution {@link QuerySolution} with results bound to variables from {@link
    ...
    public static CIMClass createCIMClass(QuerySolution classQuerySolution) {
        ...
        return CIMClass.builder()
                ...
                .label(label)
                .superClass(
                        parser.getSubClassOf(
                                CIMQueryVars.SUPER_CLASS_URI, CIMQueryVars.SUPER_CLASS_LABEL))
     ...
     *
     * @param attributeResultSet {@link ResultSet} with results bound to variables from {@link
     *     CIMQueryVars CIMQueryVars}.
    ...
    /**
     * Creates a {@link CIMAssociation} from a given query solution. Uses inverse QueryVars to
     * create the association.
     *
     * @param associationQuerySolution The query solution to create the association from.
     * @return The created association.
     */
    public static CIMAssociation createInverseCIMAssociation(
     ...
     *
     * @param associationResultSet {@link ResultSet} with results bound to variables from {@link
     *     CIMQueryVars CIMQueryVars}.
     ...
     */
    public static CIMAssociationPair createCIMAssociationPair(
            QuerySolution associationPairQuerySolution) {
     ...
     * Creates a List of {@link CIMAssociation CIMAssociations} .
     *
     * @param associationPairResultSet {@link ResultSet} with results bound to variables from {@link
     *     CIMQueryVars CIMQueryVars}.
     * @return a list containing {@link CIMAssociation CIMAssociations}.
     */
    public static List<CIMAssociationPair> createCIMAssociationPairList(
            ResultSet associationPairResultSet) {
        return createObjectList(
                associationPairResultSet, CIMObjectFactory::createCIMAssociationPair);
    }
     ...
     *
     * @param packageResultSet {@link ResultSet} with results bound to variables from {@link
     *     CIMQueryVars CIMQueryVars}.
     ...
     *
     * @param externalPackageResultSet {@link ResultSet} with results bound to {@link
     *     CIMQueryVars#URI}, {@link CIMQueryVars#LABEL}, {@link CIMQueryVars#COMMENT}, {@link
     *     CIMQueryVars#PACKAGE_URI} and {@link CIMQueryVars#PACKAGE_LABEL}.
     * @return a list containing external {@link CIMPackage CIMPackage}.
     */
    public static List<CIMPackage> createExternalCIMPackageList(
            ResultSet externalPackageResultSet) {
